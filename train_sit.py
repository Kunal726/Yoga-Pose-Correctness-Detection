...
df_test = pd.read_csv('modified_sitting_test.csv')
...
pipelines = {
    'lr':make_pipeline(
        StandardScaler(),
        LogisticRegression(random_state=42,multi_class='multinomial', solver='saga', penalty="l2")
        ),
    'rc':make_pipeline(
        StandardScaler(), 
        RidgeClassifier()
...
"""
# with open('pose_model_sitting.pkl', 'wb') as f:
