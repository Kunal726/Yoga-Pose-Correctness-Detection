...
image2 = image2.resize((1920, 1080), Image.ANTIALIAS)
...
l2 = tk.Label(window, text="Full Name :", width=20, font=("Times new roman", 15, "bold"), bg="snow")
...
l3 = tk.Label(window, text="Address :", width=20, font=("Times new roman", 15, "bold"), bg="snow")
...
l5 = tk.Label(window, text="E-mail :", width=20, font=("Times new roman", 15, "bold"), bg="snow")
l5.place(x=600, y=250)
t4 = tk.Entry(window, textvar=Email, width=20, font=('', 15))
t4.place(x=800, y=250)
# that is for email address

l6 = tk.Label(window, text="Phone number :", width=20, font=("Times new roman", 15, "bold"), bg="snow")
l6.place(x=600, y=300)
t5 = tk.Entry(window, textvar=Phoneno, width=20, font=('', 15))
t5.place(x=800, y=300)
# phone number
l7 = tk.Label(window, text="Gender :", width=20, font=("Times new roman", 15, "bold"), bg="snow")
l7.place(x=600, y=350)
# gender
tk.Radiobutton(window, text="Male", padx=5, width=5, bg="snow", font=("bold", 15), variable=var, value=1).place(x=800,
                                                                                                                y=350)
tk.Radiobutton(window, text="Female", padx=20, width=4, bg="snow", font=("bold", 15), variable=var, value=2).place(
    x=915, y=350)

l8 = tk.Label(window, text="Age :", width=20, font=("Times new roman", 15, "bold"), bg="snow")
l8.place(x=600, y=400)
t6 = tk.Entry(window, textvar=age, width=20, font=('', 15))
t6.place(x=800, y=400)

l4 = tk.Label(window, text="User Name :", width=20, font=("Times new roman", 15, "bold"), bg="snow")
l4.place(x=600, y=450)
t3 = tk.Entry(window, textvar=username, width=20, font=('', 15))
t3.place(x=800, y=450)


l9 = tk.Label(window, text="Password :", width=20, font=("Times new roman", 15, "bold"), bg="snow")
l9.place(x=600, y=500)
t9 = tk.Entry(window, textvar=password, width=20, font=('', 15), show="*")
t9.place(x=800, y=500)

l10 = tk.Label(window, text="Confirm Password:", width=20, font=("Times new roman", 15, "bold"), bg="snow")
l10.place(x=600, y=550)

t10 = tk.Entry(window, textvar=password1, width=20, font=('', 15), show="*")
t10.place(x=800, y=550)

btn = tk.Button(window, text="Register", bg="purple",font=("",20),fg="white", width=9, height=0, command = insert)
